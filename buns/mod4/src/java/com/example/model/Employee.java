...
import java.com.example.valid.CheckEmail;
import java.util.ArrayList;
import java.util.List;

public class Employee {

    @Size(min=2, message = "имя должно состоять из 2 или более символов")
    private String name;
    ...
    @Pattern(regexp = "\\d{3} \\d{3}-\\d{2}-\\d{2}", message = "должен совпадать XXX XXX-XX-XX")
